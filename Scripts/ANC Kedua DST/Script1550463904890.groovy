...
Mobile.startApplication('C:\\Users\\Sehati - Nita\\Software\\bidan-app-universal-debug-39e6767.apk', true)
...
Mobile.tap(findTestObject('ANC/android.widget.LinearLayout10'), 0)
...
Mobile.setText(findTestObject('ANC/android.widget.EditText1 - Tinggi badan Pasien'), '160', 0)
...
Mobile.setText(findTestObject('ANC/android.widget.EditText4 - Lingkar lengan Pasien'), '25', 0)
...
Mobile.setText(findTestObject('ANC/android.widget.EditText2 - Hasil Laboratorium Lainnya'), 'ruam pada kulit', 0)
...
Mobile.tap(findTestObject('ANC/android.widget.Button0 - Tidak simpan'), 0)
