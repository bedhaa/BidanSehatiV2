...
Mobile.tap(findTestObject('Prof bidan/android.widget.TextView12 - Profil'), 0)
...
Mobile.setText(findTestObject('Prof bidan/android.widget.EditText1 - Nama Klinik atau Nama Anda'), 'NAN DINANTI', 0)
...
Mobile.setText(findTestObject('Prof bidan/android.widget.EditText5 - Nama Jalan Nomor Rumah RTRW'), 'Jl. Buah Hati', 0)
